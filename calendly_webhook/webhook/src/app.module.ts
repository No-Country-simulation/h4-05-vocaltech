...
import { TemporalAppointmentService } from './appointments/appointment/temporal-appointment/temporal-appointment.service';
...
@Module({
  ...
  providers: [AppService, AppointmentService, HttpClientService, TemporalAppointmentService],
})
