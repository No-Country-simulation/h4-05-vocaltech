...
const Technology = ({ title, description }) => {
    const [isHovered, setIsHovered] = useState(false);

    return (
        <div
            className={`diagnostic-card technology ${isHovered && "hovered"}`}
        ...
        >
            ...
            {isHovered && (
                <img
                    src="/images/entrepreneur-man.png"
                    alt="Background Image"
                    className="position-absolute bottom-0 end-0 img-fluid opacity-25"
                    style={{ height: "287px", width: "230px", marginBottom: "-0.5rem", marginRight: "-0.1rem" }}
                />
            )}
            ...
            {!isHovered ? (
                <>
                    ...
                    <div className="d-flex align-items-center p-3">
                        <img src="/images/cpu-bolt.png" alt="Microphone Icon" className="me-2" style={{ width: "24px", height: "24px" }} />
